      ...
      <el-col :md="20">
        <el-tabs v-model="materialType" @tab-click="handleClick">
            ...
            <div class="waterfall" v-loading="tableLoading">
              <div class="waterfall-item" v-for="item in tableData" :key='item.id'>
                ...
                <el-row class="ope-row">
                  <el-button v-if="permissions.mp_wxmaterial_del" type="danger" icon="el-icon-delete" circle @click="delMaterial(item)"></el-button>
                </el-row>
              </div>
            </div>
          ...
          <el-tab-pane name="video">
            ...
            <div class="add_but">
              <el-button v-if="permissions.mp_wxmaterial_add" size="mini" type="primary" @click="handleAddVideo">新建</el-button>
            </div>
          ...
          <el-tab-pane name="news">
            ...
            <div class="add_but">
              <el-button type="primary"
                         v-if="permissions.mp_wxmaterial_add"
                         @click="handleAddNews"
                         size="mini">新 增
              </el-button>
            </div>
              ...
              <div class="left">
                <div class="select-item">
                  <div v-for="(news, index) in articlesAdd" :key='news.id'>
                    ...
                    <div class="news-main-item father" v-if="index>0"
              ...
              <div class="right" v-loading="addMaterialLoading">
                ...
                <div>
                  <div class="thumb-div">
                    ...
                    <div class="thumb-but">
                      <el-upload
                        ...
                        <el-button size="mini" type="primary" @click="openMaterial" style="margin-left: 5px">素材库选择
                        </el-button>
                  ...
                  <el-dialog title="选择图片" :visible.sync="dialogImageVisible" width="80%" append-to-body>
                    <WxMaterialSelect :objData="{repType:'image',appId: checkAppId}"
            ...
            <div class="waterfall" v-loading="tableLoading">
              <div v-if="item.content && item.content.articles" class="waterfall-item" v-for="item in tableData"
                   :key='item.id'>
